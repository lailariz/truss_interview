# Instructions
Hi Truss.works! Here you can find my submission for the takehome project.
...
#### Tests
`python test_process_csv.py`

#### Run the Project
`python process_csv.py < sample.csv` where sample.csv is any file you
would like to be normalized. To output the normalized data to a file,
send the output like this `python process_csv.py < sample.csv > out.csv`
